...
public class SecurityUtil {
    ...
    public func getPrivateKeyFromP12(targetBundle : String, p12KeystoreName : String, p12Key : String) throws -> SecKey{
        
        debugPrint("p12KeystoreName: " + p12KeystoreName)
        
        //Refer to framework bundle
        let bundle = Bundle(identifier: targetBundle)
    ...
    /// - Throws: Exception (e.g. FileAndPathError)
    public func getPublicCertFromP12(targetBundle : String, p12KeystoreName : String, p12Key : String) throws -> SecCertificate{
    ...
    /// - Throws: Exception
    public func getL2Signature(baseString:String, privateKey:SecKey, commonDigest:String) throws -> String? {
    ...
    /// - Throws: Exception
    public func getL1Signature(baseString:String, secret:String, commonDigest:String) throws -> String? {
    ...
    /// - Returns: Boolean value
    /// - Throws: Exception
    public func verifyL2Signature(signature:String, publicCert:SecCertificate, baseString:String, commonDigest:String) throws -> Bool? {
    ...
    /// Function to generate nonce value
    ///
    /// - Returns: random nonce in String format
    public func getNewNonce() -> String{
    ...
    public func getNewTimeStamp() -> String{
    ...
    public func currentTimeMilliseconds() -> Int {
    ...
    /// - Returns: Boolean value
    public func validateURLScheme(strURL:String ) -> Bool{
    ...
    public func getAbsoluteURL(strURL:String ) -> String{
    ...
    public func decodeURL(str: String) -> String{
    ...
    /// - Throws: Exception
    public func getBaseString(strAppId: String,
    ...
    /// - Throws: Exception
    public func getToken(strRealm: String,
                         strAppId: String,
                         strSecret: String?,
                         strURLNoPortNbr: String,
                         strAuthPrefix:String,
                         ...
                         strAlias:String,
                         strFileName:String?,
                         strTargetBundle:String) throws -> String {
        
        debugPrint("Enter :: getToken :: strRealm : \(strRealm) , strAppId : \(strAppId), strURLNoPortNbr : \(strURLNoPortNbr) , strAuthPrefix: \(strAuthPrefix), strSecret : \(strSecret), strHttpMethod : \(strHttpMethod), strNonce : \(strNonce), strTimeStamp : \(strTimeStamp), strPassword : \(strPassword), strAlias : \(strAlias), strFileName : \(strFileName), strTargetBundle : \(strTargetBundle)")
        ...
        if (strSecret != nil) {
            ...
            let privateKey:SecKey = try getPrivateKeyFromP12(targetBundle: strTargetBundle, p12KeystoreName: strFileName!, p12Key: strPassword!)
